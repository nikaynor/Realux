...
accordionItems.forEach((items) =>{
  const accordionHeader = items.querySelector('.value__accordion-header')
...
const toggleItem = (items) =>{
  ...
  const accordionContent = items.querySelector('.value__accordion-content')
